...
Priest::Priest(const uint8_t level, const Vector2Int& mapPos, const Team team, const unsigned int groupNum, MapCtrl& mapCtrl, SceneController& ctrl,
...
PriestBC::PriestBC(Charactor& charactor, const int imageHandle, Camera& camera) : BattleCharactor(charactor, imageHandle, camera)
{
...
std::shared_ptr<Effect> PriestBC::CreateAttackEffect(const Vector2Int& effectPos)
{
