...
Warrior::Warrior(const Vector2Int& mapPos, const Team team, MapCtrl& mapCtrl, SceneController& ctrl,
	std::vector<std::shared_ptr<Effect>>& effects)
	:Charactor(mapPos, team, mapCtrl, ctrl, effects)
{
	_battleC = make_shared<WarriorBC>(*this);
	...
	_status = Status(1, 100, 10, 5, 5, 5, 5, 5, Attribute::green);
...
WarriorBC::WarriorBC(Charactor& charactor) : BattleCharactor(charactor)
{
	_name = "Warrior";
	const Size divSize = Size(32, 32);
	_animator->SetImage("Resource/Image/Charactor/charactor.png");
